...
const images = {
  ...
  plusCacheInvalidation: require("../assets/plus-cache-invalidation.png"),
  varnish: require("../assets/varnish.png"),
};
      ...
      <Spectacle theme={theme}>
        <Deck transition={["zoom", "slide"]} transitionDuration={500}>
          ...
          <Slide transition={["slide", "spin"]} bgColor="primary" notes="Varnish & Redis, the popular choices for the two different ways of caching.">
            ...
            <Link href="https://github.com/wisc/redis-varnish-presentation">
          ...
          <Slide transition={["slide"]} bgColor="#1f5a9d" notes="1. Varnish sits in front of the webserver (or in front of node app)<br />2. It's a layer between the user and the app.<br />3. In memoryyyy">
            <Image src={images.varnish.replace("/", "")} margin="0" />
          </Slide>
          ...
          <Slide transition={["slide"]} bgColor="primary" notes="- Kubernetes API gives all varnish instances<br />- ">
            <Heading size={2}  caps textColor="white">
              Varnish
            </Heading>
            <Heading size={2} fit caps textColor="black">
            ...
            <Image src={images.plusCacheInvalidation.replace("/", "")} margin="0" />
            <List>
                <ListItem>go through all varnish cache servers. Invalidate cache.</ListItem>
                <ListItem>go through all varnish cache servers. Call all endpoints.</ListItem>
            </List>
          </Slide>
          ...
          <Slide transition={["slide"]} bgColor="primary" notes="Cache invalidation is done by listing dependencies in the key name.">
            ...
            <List>
                <ListItem>&lt;resource&gt;<b>:</b>&lt;id|all&gt;<b>_</b>&lt;resource&gt;<b>:</b>&lt;id|all&gt;</ListItem>
                <ListItem>table:1337</ListItem>
                <ListItem><b>appid:1</b>_version:4_table:1337</ListItem>
                <ListItem>appid:1_version:4_<b>table:all</b></ListItem>
            </List>
          </Slide>
